...
public class NovoStatusAnimacao {
	private double x;
	private double y;
	...
	public static ArrayList<NovoStatusAnimacao> todasStatusAni = new ArrayList<NovoStatusAnimacao>();

	public NovoStatusAnimacao(int x, int y, String status) {
		this.status = status;
	...
	public NovoStatusAnimacao(int x, int y, String status, Color cor, int tamanho) {
		addCor(cor);
		this.status = status;
		this.x = x - (status.length() * 3);
		this.y = y - 28;
	...
	public NovoStatusAnimacao(int x, int y, String status, Color[] cores, int tamanho) {
