...
public class ModValorAnimaçao {
	...
	public static ArrayList<ModValorAnimaçao> todosModAni = new ArrayList<ModValorAnimaçao>();
	
	public ModValorAnimaçao(int x, int y, int valor, Color cor) {
		this.x = x;
		this.y = y - 8;
