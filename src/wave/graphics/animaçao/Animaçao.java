...
public class Animaçao extends Dimensional implements AnimaçaoInterface{
	...
	public static final BufferedImage fumaçaSprite = Util.carregarImg("/Sprites/fumaça.png");
	public static final BufferedImage fumaçaClaraSprite = Util.carregarImg("/Sprites/fumaçaClara.png");
	...
	public static final BufferedImage peca1 = Util.carregarImg("/Sprites/peça1.png");
	public static final BufferedImage peca3 = Util.carregarImg("/Sprites/peça3.png");
	public static final BufferedImage peca4 = Util.carregarImg("/Sprites/peça4.png");
	...
	public static final ArrayList<BufferedImage> fumaçaImgs = Util.carregarArrayBI(Animaçao.fumaçaClaraSprite, 0, 0, 128, 128, 38);
	public static final ArrayList<BufferedImage> fumaçaEscuraImgs = Util.carregarArrayBI(Animaçao.fumaçaSprite, 0, 0, 128, 128, 38);
	public static final ArrayList<BufferedImage> particulaEsfericaImgs = Util.carregarArrayBI(Animaçao.particulaEsferica, 0, 0, 60, 60, 60);
	...
	public Animaçao(int xCentro, int yCentro, ArrayList<BufferedImage> imgs, int tickPorIndex) {
		this.x = xCentro;
		this.y = yCentro;
		this.imgs = imgs;
	...
	public static void aniFumaçaPadrao(int xCentro, int yCentro) {
		Animaçao ani = new Animaçao(xCentro, yCentro, fumaçaImgs, 3);
		ani.setScale(.6f);
		ani.setFadeOut(70);
		ani.start();
	}
