...
public class AnimaçaoSprite {
	...
	public AnimaçaoSprite(ArrayList<BufferedImage> sprites, int delay) {
	...
	public AnimaçaoSprite(ArrayList<BufferedImage> sprites, int delay, AnimaçaoSpriteGrupo grupo) {
		this.sprites = sprites;
		this.delay = delay;
