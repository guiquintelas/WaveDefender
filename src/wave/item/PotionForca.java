...
public class PotionForca extends Item implements Usavel{
	public static boolean primeira = true;
	public static int quantos = 0;
	public static final BufferedImage imgPot = Util.carregarImg("/Sprites/potionForca.png");

	public PotionForca(int x, int y) {
	...
	public void usar() {
		...
		Animacao ani = new Animacao(Player.getPlayer().getXCentro(), Player.getPlayer().getYCentro(), Animacao.raiosImgs, 4);
	...
	public String getText() {
		return "Uma pocão mágica que aumenta seu dano, duracão de 10 segundos.";
	}
